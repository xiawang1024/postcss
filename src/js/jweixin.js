// from https://res.wx.qq.com/open/js/jweixin-1.3.2.js
!(function(e, n) {
		...
		k &&
			(e.WeixinJSBridge
				? 'preInject' === I.__wxjsjs__isPreInject
					? I.addEventListener && I.addEventListener('WeixinJSBridgeReady', n, !1)
					: n()
				: I.addEventListener && I.addEventListener('WeixinJSBridgeReady', n, !1));
	}
	function m() {
	...
	if (!e.jWeixin) {
		var h = {
			...
			V = { initStartTime: p(), initEndTime: 0, preVerifyStartTime: 0, preVerifyEndTime: 0 },
			A = {
				version: 1,
				appId: '',
				initTime: 0,
		...
		var E = !1,
			...
			N = {
				...
				launchMiniProgram: function(e) {
					i(
						'launchMiniProgram',
						{ targetAppId: e.targetAppId, path: g(e.path), envVersion: e.envVersion },
						e
					);
				},
				miniProgram: {
