		...
		for (var b = [], d = 0, e = this.data.length; e > d; d++) {
			...
			f > 65536
				...
				: f > 2048
					...
					: f > 128 ? ((b[0] = 192 | ((1984 & f) >>> 6)), (b[1] = 128 | (63 & f))) : (b[0] = f),
		...
		(b.prototype = {
			...
			setupTypeInfo: function(a, b) {
				for (var c = (this.errorCorrectLevel << 3) | b, d = f.getBCHTypeInfo(c), e = 0; 15 > e; e++) {
					...
					6 > e
						? (this.modules[e][8] = g)
						: 8 > e ? (this.modules[e + 1][8] = g) : (this.modules[this.moduleCount - 15 + e][8] = g);
				}
				for (var e = 0; 15 > e; e++) {
					var g = !a && 1 == (1 & (d >> e));
					8 > e
						? (this.modules[8][this.moduleCount - e - 1] = g)
						: 9 > e ? (this.modules[8][15 - e - 1 + 1] = g) : (this.modules[8][15 - e - 1] = g);
				}
